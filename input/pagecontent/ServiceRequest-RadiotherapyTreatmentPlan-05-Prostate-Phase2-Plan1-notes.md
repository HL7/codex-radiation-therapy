...
Title: "RadiotherapyTreatmentPlan-05-Prostate-Phase2-Plan1"
...
* basedOn[0] = Reference(RadiotherapyPlannedPhase-05-Prostate-Phase2) "Prostate-Phase2"
* basedOn[+] = Reference(RadiotherapyPlanPrescription-05-Prostate-Phase2-Plan1) "Prostate-Phase2-Plan1"
* status = #active
* intent = #filler-order
