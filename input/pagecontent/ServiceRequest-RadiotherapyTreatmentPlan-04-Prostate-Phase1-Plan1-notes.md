...
Title: "RadiotherapyTreatmentPlan-04-Prostate-Phase1-Plan1"
...
* extension[+]
  * extension[0]
    * url = "instanceUid"
    * valueId = "1.2.246.352.71.5689073982433245406.1530811633039636638"
  * extension[+]
    * url = "sopClass"
    * valueCoding = urn:ietf:rfc:3986#urn:oid:1.2.840.10008.5.1.4.1.1.481.5
...
* basedOn[0] = Reference(RadiotherapyPlannedPhase-04-Prostate-Phase1) "Prostate-Phase1"
