...
* A new [RadiotherapyDiseaseStatus](StructureDefinition-codexrt-radiotherapy-disease-status.html) profile was added based on mCODE's [CancerDiseaseStatus](http://hl7.org/fhir/us/mcode/STU2/StructureDefinition-mcode-cancer-disease-status.html) profile with an additional qualifier for [disease progression](http://build.fhir.org/ig/HL7/codex-radiation-therapy/ValueSet-codexrt-disease-progression-qualifier-vs.html)).([FHIR-37922](https://jira.hl7.org/browse/FHIR-37922))
* Added a [RadiotherapyTreatmentLocation](StructureDefinition-codexrt-radiotherapy-treatment-location.html) profile that captures the [Treatment Location type](ValueSet-codexrt-radiotherapy-treatment-location-type-vs.html).
...
* An extension with a [Reference to DICOM SOP Instance](codex-radiation-therapy/StructureDefinition-codexrt-dicom-reference.html) was added to RadiotherapyTreatmentPlan and RadiotherapyTreatedPlan profiles.
