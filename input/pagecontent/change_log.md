...
* Profile Changes
  ...
  * Changed binding strengths as done and discussed in mCODE 3.0 because required bindings were a barrier to broader implementation. ([FHIR-42775](https://jira.hl7.org/browse/FHIR-42775), mCODE change [FHIR-41503](https://jira.hl7.org/browse/FHIR-41503)). The binding strength was changed from required to extensible on the following elements.
    * bodySite in all Procedure and ServiceRequest resources was changed from required to extensible (same as in the [mCODE STU3 RadiotherapyCourseSummary](https://hl7.org/fhir/us/mcode/STU3/StructureDefinition-mcode-radiotherapy-course-summary.html)).
