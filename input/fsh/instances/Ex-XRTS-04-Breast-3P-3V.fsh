...
* extension[respiratoryMotionManagement][+].valueCodeableConcept = SnomedRequestedCS#721071000124104 "External beam radiotherapy with free breathing (procedure)"
* extension[freeBreathingMotionManagementTechnique][+].valueCodeableConcept = SnomedRequestedCS#721061000124106 "External beam radiotherapy with respiratory gating (procedure)"
