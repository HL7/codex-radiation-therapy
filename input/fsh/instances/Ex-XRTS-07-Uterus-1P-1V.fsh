...
* extension[grade].valueCodeableConcept = NCIT#C41339 "Moderate Adverse Event" // NCIT#C41338 "Mild Adverse Event"
* extension[severity].valueCodeableConcept = AESEVERITY#mild "mild" // NCIT#C41338 "Mild Adverse Event"
