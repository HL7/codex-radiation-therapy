...
// * extension[mcode-radiotherapy-modality-and-technique][1].extension[technique][0].valueCodeableConcept = $mCODESCT_TBD#1162782007 "Three dimensional external beam radiation therapy (procedure)"
