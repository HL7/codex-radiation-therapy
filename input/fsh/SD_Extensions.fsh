...
Extension: RadiotherapyDoseToVolume
Id: codexrt-radiotherapy-dose-to-volume
Title: "Dose to Volume"
Description: "Dose parameters for one radiotherapy volume."
* . ^short = "Dose to a Dose Reference"
* extension contains
    volume 1..1 MS and
...
* extension[volume]
  ...
  * value[x] 1..1
  * ^short = "Volume targeted by the dose"
...
* extension[fractionDose]
  ...
  * ^short = "Radiation Dose per Fraction"
  * ^definition = "The dose per Fraction to this volume."
* extension[totalDose]
  * value[x] only Quantity
  * value[x] 1..1
  * valueQuantity = UCUM#cGy
  * ^short = "Total Radiation Dose"
  * ^definition = "The total dose to this volume within the scope of this ServiceRequest."
* extension[fractions]
  * value[x] only positiveInt
  * value[x] 1..1
  * ^short = "Number of Fractions"
  * ^definition = "The number of Fractions to deliver the dose. This element is used if the number of fractions may differs between volumes, for example in a Course Summary. If the number of fractions is the same for all volumes, then a dedicated extension for number of fractions shall be used."


Extension: RadiotherapyDosePrescribedToVolume
Parent: RadiotherapyDoseToVolume
