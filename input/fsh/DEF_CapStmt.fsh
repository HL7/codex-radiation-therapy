...
Usage: #definition
* rest.documentation =  "A CodeXRT Server **SHALL**:\n\n1.  Implement the RESTful behavior according to the FHIR specification.\n1. Return the following response classes:\n   - (Status 400): invalid parameter\n   - (Status 401/4xx): unauthorized request\n   - (Status 403): insufficient scope\n   - (Status 404): unknown resource\n   - (Status 410): deleted resource.\n1. Support json source formats for all CodexRT interactions.\n2. Identify the CodexRT  profiles supported as part of the FHIR `meta.profile` attribute for each instance.\n3. Support the searchParameters on each profile individually and in combination.\n\nThe CodexRT Server **SHOULD**:\n\n4. Support xml source formats for all CodexRT interactions.\n"
